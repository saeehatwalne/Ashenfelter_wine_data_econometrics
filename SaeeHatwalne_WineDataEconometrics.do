...
********************************************************************************
clear all
global pathin = "/Users/saeehatwalne/Desktop/APU 2023-25/Econometrics_STATA/WineData"
global pathout =  "/Users/saeehatwalne/Desktop/APU 2023-25/Econometrics_STATA/WineData"
log using "$pathout/SaeeHatwalne_WineDataEconometrics.smcl"
log on
********************************************************************************
import delimited "wine.csv"
br

//For predicting the natural log of the price of wine. Which regressors predict this variable best:
...
//Ashenfelter claims that weather is the key determinant of wine prices. 
//Replicating Figures 1 and 2 from the paper and explain his arguments.
...
//Combining the two columns to disaply the regressions
esttab reg1 reg2 using "regressions.tex", r2 ar2 se scalar(rmse) replace

//Goodness of fit and lnprice relative to 1961 as dependent variable
